...
namespace amc13{
  ...
  Exception::exBase::exBase() throw() : descriptionSize(255),
					stackSize(1024), 
					PID(-1)
  {
  ...
  void Exception::exBase::Copy(const exBase & rh) throw()
  {
  ...
  void Exception::exBase::Append(const char * buffer) throw()
  {
  ...
  const char * Exception::exBase::Description() const throw() 
  {
